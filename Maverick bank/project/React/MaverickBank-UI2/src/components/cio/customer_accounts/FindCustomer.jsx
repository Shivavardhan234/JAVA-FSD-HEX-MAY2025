...
function FindCustomer() {
    ...
    const fetchCustomer = async () => {
        try {
            ...
            let url = "";
            if (searchType === "by-id") {
                url = `http://localhost:9090/api/customer/get/by-id/${searchValue}`;
            } else {
                url = `http://localhost:9090/api/customer/get/by-user-id/${searchValue}`;
            }
                        ...
                        <div className="card-header bg-secondary bg-opacity-10 fw-semibold"
                            ...
                            <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                ...
                                <div className="input-group" style={{ maxWidth: '300px' }}>
                                    ...
                                    <button className="btn btn-outline-secondary" onClick={() => fetchCustomer()}>
